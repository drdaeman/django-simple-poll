...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Poll.publication_date'
        db.add_column(u'poll_poll', 'publication_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.date.today),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Poll.publication_date'
        db.delete_column(u'poll_poll', 'publication_date')
